        ...
        <main className='flex justify-center items-center'>
            <div className='divide-y divide-gray-400 max-w-3xl lg:max-w-5xl p-4'>
                <div className='p-4'>
                    ...
                    <p className='text-sm font-light text-gray-500'>{format(parseISO(date), 'MMMM do, uuu')}</p>
                </div>
                <div className='p-4 prose dark:prose-invert max-w-none'><MDXRemote {...content} /></div>
            </div>
        </main>
        </div>
    )
